      ...
      <section className="content">
        ...
        <div className="vision">
          ...
          <ul className="text-list-bullet-point">
            ...
            <li>
              Chúng tôi mang đến giải pháp tiện lợi, nhanh chóng và thân thiện,
              giúp bạn kết nối liên tục mà không bị gián đoạn – dù đang học tập,
        ...
        <div className="mission">
          ...
          <ul className="text-list-bullet-point">
            ...
            <li>
              ...
              trải nghiệm năng lượng thông minh, giúp con người kết nối, chia sẻ
              và sống năng động hơn mỗi ngày.
            </li>
          </ul>
        </div>
      </section>
